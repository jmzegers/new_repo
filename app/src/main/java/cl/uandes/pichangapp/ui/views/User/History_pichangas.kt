...
class History_pichangas : Fragment(), ItemAdapter.ActionListener  {
    ...
    private var _binding: HistoryPichangasBinding? = null
    private val binding get() = _binding!!
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = HistoryPichangasBinding.inflate(inflater, container, false)
    ...
    override fun goToFighterDetails(fighter: DataMatch) {
        ...
        findNavController().navigate(R.id.action_history_pichangas_to_selected_item, bundle)
    }
}