 ...
 * Use the [Voucher.newInstance] factory method to
 * create an instance of this fragment.
 */
class Voucher : Fragment() {
    ...
    private var _binding: VoucherBinding? = null
    private val binding get() = _binding!!
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = VoucherBinding.inflate(inflater, container, false)
        return binding.root
    }
